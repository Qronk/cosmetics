        ...
        <div class="card-carousel">
            ...
            <div class="card-carousel--overflow-container">
                <div class="card-carousel-cards" :style="{ transform: 'translateX' + '(' + currentOffset + 'px' + ')'}">
                    <div class="card-carousel--card" v-for="products in filteredrec">
...
<script>
    export default {
        ...
        computed: {
            ...
            atEndOfList() {
                return this.currentOffset <= (this.paginationFactor * -1) * (10 - this.windowSize);
            },
            atHeadOfList() {
        ...
        methods: {
            moveCarousel(direction) {
                ...
                console.log(this.filteredrec.lenght);
